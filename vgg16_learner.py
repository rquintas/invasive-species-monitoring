...
def model_vgg16_finetune_more_layers(img_width, img_height):
    ...
    model = Model(input=base_model.input, output=top_model(base_model.output), name='vgg16')
...
if __name__ == '__main__':
    ...
    ###################
    # Create model.
    model = model_vgg16_finetune_more_layers(256, 256)
